        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="{{route('order.index',$date)}}" method="get" id="form">
                        <div class="row">
                            ...
                            <div class="col-sm-2 m-b">
                                <a class="btn btn-sm btn-info" href="{{route('order_date.index')}}"> 返回订单列表</a>
                            </div>
                        </div>
                            ...
                            @foreach($rows as $row)
                                <tr>
                                    ...
                                    <th class="text-middle">
                                        <i class="fa {{ $row->printStatusDisplay('icon') }}"></i> {{ $row->printStatusDisplay() }}
                                    </th>
                                    <td class="text-middle">{{$row->created_at}}</td>
                                    <td class="text-middle">
                                        <a class="btn btn-white btn-xs print"
                                           attr-url="{{route('order.print', $row->id)}}">
